...
w=p(2);
if w>0
    sws1(p(1),2:w)=sws1(p(1),1:w-1);              % shift of series 1 and 2 window
    sws2(p(1),2:w)=sws2(p(1),1:w-1);      
    sws1(p(1),1)=v(1);                             % addition of new entry to series 1 and 2 window
    sws2(p(1),1)=v(2);                       
    ser1=sws1(p(1),:);                             % local shortnotation for series 1 and 2
    ser2=sws2(p(1),:);
